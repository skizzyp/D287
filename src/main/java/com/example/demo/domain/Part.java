...
public abstract class Part implements Serializable {
    ...
    public void validateMinMax() {
        if(this.inv < this.min) {
            throw new RuntimeException("Invalid Inventory Value: Below Minimum");
        } else if (this.inv > this.max) {
            throw new RuntimeException("Invalid Inventory Value: Higher than Maximum");
        }
    }
    @Override
