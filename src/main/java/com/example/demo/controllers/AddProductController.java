...
//        product.getParts().addAll(assparts);
    ...
    public String buyProduct(@RequestParam("id") Long theId) {
        Optional<Product> productPurchased = productRepository.findById(theId);
        //check if product exists
        if(productPurchased.isPresent()) {
            Product product = productPurchased.get();
